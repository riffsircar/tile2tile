...
images_32 = {
    'P': Image.open('tiles_32/P.png'),
    '-': Image.open('tiles_32/-.png'),
    # SMB
    '<': Image.open('tiles_32/SMB_PTL.png'),
    '>': Image.open('tiles_32/SMB_PTR.png'),
    '[': Image.open('tiles_32/SMB_[.png'),
    ']': Image.open('tiles_32/SMB_].png'),
    '?': Image.open('tiles_32/SMB_Q.png'),
    'B': Image.open('tiles_32/SMB_B.png'),
    'b': Image.open('tiles_32/SMB_bb.png'),
    'G': Image.open('tiles_32/SMB_G.png'),
    'Q': Image.open('tiles_32/SMB_Q.png'),
    'S': Image.open('tiles_32/SMB_S.png'),
    'X': Image.open('tiles_32/SMB_X.png'),
    'o': Image.open('tiles_32/SMB_o.png'),
    'E': Image.open('tiles_32/SMB_E.png'),

    # KI
    '#': Image.open('tiles_32/KI_#.png'),  # solid
    'D': Image.open('tiles_32/KI_D.png'),
    'H': Image.open('tiles_32/KI_H.png'),
    'M': Image.open('tiles_32/KI_M.png'),
    'T': Image.open('tiles_32/KI_T.png'),

    # MM
    "*": Image.open('tiles_32/MM_star.png'),
    '+': Image.open('tiles_32/MM_+.png'),
    'C': Image.open('tiles_32/MM_C.png'),
    'L': Image.open('tiles_32/MM_ll.png'),
    'U': Image.open('tiles_32/MM_U.png'),
    'W': Image.open('tiles_32/MM_w.png'),
    'h': Image.open('tiles_32/MM_H.png'),
    'l': Image.open('tiles_32/MM_ll.png'),
    'm': Image.open('tiles_32/MM_M.png'),
    's': Image.open('tiles_32/MM_S.png'),
    't': Image.open('tiles_32/MM_T.png'),
    'w': Image.open('tiles_32/MM_w.png'),
    'x': Image.open('tiles_32/MM_X.png'),
    '|': Image.open('tiles_32/MM_L.png'),

    # Met
    '^': Image.open('tiles_32/Met_^.png'),
    'd': Image.open('tiles_32/Met_D.png'),
    'e': Image.open('tiles_32/Met_E.png'),
    'g': Image.open('tiles_32/Met_G.png'),
    'r': Image.open('tiles_32/Met_R.png'),
    'u': Image.open('tiles_32/Met_U.png')
}

images_64 = {
    'P': Image.open('tiles_64/P.png'),
    '-': Image.open('tiles_64/-.png'),
    # SMB
    '<': Image.open('tiles_64/SMB_PTL.png'),
    '>': Image.open('tiles_64/SMB_PTR.png'),
    '[': Image.open('tiles_64/SMB_[.png'),
    ']': Image.open('tiles_64/SMB_].png'),
    '?': Image.open('tiles_64/SMB_Q.png'),
    'B': Image.open('tiles_64/SMB_B.png'),
    'b': Image.open('tiles_64/SMB_bb.png'),
    'G': Image.open('tiles_64/SMB_G.png'),
    'Q': Image.open('tiles_64/SMB_Q.png'),
    'S': Image.open('tiles_64/SMB_S.png'),
    'X': Image.open('tiles_64/SMB_X.png'),
    'o': Image.open('tiles_64/SMB_o.png'),
    'E': Image.open('tiles_64/SMB_E.png'),

    # KI
    '#': Image.open('tiles_64/KI_#.png'),  # solid
    'D': Image.open('tiles_64/KI_D.png'),
    'H': Image.open('tiles_64/KI_H.png'),
    'M': Image.open('tiles_64/KI_M.png'),
    'T': Image.open('tiles_64/KI_T.png'),

    # MM
    "*": Image.open('tiles_64/MM_star.png'),
    '+': Image.open('tiles_64/MM_+.png'),
    'C': Image.open('tiles_64/MM_C.png'),
    'L': Image.open('tiles_64/MM_ll.png'),
    'U': Image.open('tiles_64/MM_U.png'),
    'W': Image.open('tiles_64/MM_w.png'),
    'h': Image.open('tiles_64/MM_H.png'),
    'l': Image.open('tiles_64/MM_ll.png'),
    'm': Image.open('tiles_64/MM_M.png'),
    's': Image.open('tiles_64/MM_S.png'),
    't': Image.open('tiles_64/MM_T.png'),
    'w': Image.open('tiles_64/MM_w.png'),
    'x': Image.open('tiles_64/MM_X.png'),
    '|': Image.open('tiles_64/MM_L.png'),

    # Met
    '^': Image.open('tiles_64/Met_^.png'),
    'd': Image.open('tiles_64/Met_D.png'),
    'e': Image.open('tiles_64/Met_E.png'),
    'g': Image.open('tiles_64/Met_G.png'),
    'r': Image.open('tiles_64/Met_R.png'),
    'u': Image.open('tiles_64/Met_U.png')
}

all_images = {16: images, 32: images_32, 64: images_64}
