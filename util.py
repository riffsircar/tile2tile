...
affs = {'smb': 'affordances/aff_smb.json', 'ki':'affordances/aff_ki.json', 'mm': 'affordances/aff_mm.json', 'met':'affordances/aff_met.json'}
...
def get_tile_for_aff(aff,game):
    # if aff == '-':
    #     return ['-']
    return ['-'] if aff == '-' else aff_to_tile[game][aff]
